...
base_dir = r"C:\\Fichiers_Users\\funigo\\doc\\jpltgrammaire"
input_file = os.path.join(base_dir, "GrammaireN5_extrait.txt")
output_file = os.path.join(base_dir, "Grammaire_JLPT_N5.csv")
...
# 🧹 Nettoyage
text = text.replace("Grammaire du JLPT N5\nGo-I 語彙 : www.go-i.fr\n", "")
