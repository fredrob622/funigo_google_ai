...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (quizOraNiveau) {
        ...
        quizOraNiveauSelect.addEventListener('change', () => {
             // On s'assure qu'une valeur a été sélectionnée (pas l'option vide)
             if (quizOraNiveauSelect.value) {
                 // On soumet le formulaire directement avec la valeur sélectionnée
                 quizOraNiveau.submit();
             }
        });
